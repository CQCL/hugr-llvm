...
//! can be the parameters of functions, the results of instructions, constants,
//! symbol references to globals, and other more esoteric things. Mostly we use
//! [BasicValueEnum] or [BasicValue].
//!
...
//! inserts instructions into a basic block into a basic block. A builder has a
//! "current position" where the next instruction will be inserted. It has many
//! functions such as [inkwell::builder::Builder::build_call] which are used to create and insert
//! instructions.
//!
